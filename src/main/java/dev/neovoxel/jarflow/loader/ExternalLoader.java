...
public class ExternalLoader {
    ...
    public static void init() {
        ...
        if (classLoader.getClass().getName().contains("jdk.internal.loader.ClassLoaders$AppClassLoader")) {
            return;
        }
        ...
        try {
            ...
            System.err.println("[JarFlow] Note: MethodHandle injection failed, relying on Instrumentation: " + e.getMessage());
        }
    }
    ...
    public void load(File file) throws Throwable {
        if (instrumentation != null) {
            try (JarFile jarFile = new JarFile(file)) {
                ...
                System.err.println("Instrumentation injection failed: " + e.getMessage());
            }
        }
